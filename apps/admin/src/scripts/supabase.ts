    ...
    Tables: {
      ...
      announcements: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "announcements_owner_id_fkey"
            columns: ["owner_id"]
            isOneToOne: false
            referencedRelation: "entities"
            referencedColumns: ["id"]
      ...
      attendances: {
        ...
        Relationships: [
          {
            foreignKeyName: "public_attendances_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "employees"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "public_attendances_owner_id_fkey"
            columns: ["owner_id"]
            isOneToOne: false
            referencedRelation: "entities"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "public_attendances_updated_by_fkey"
            columns: ["updated_by"]
            isOneToOne: false
            referencedRelation: "employees"
            referencedColumns: ["id"]
